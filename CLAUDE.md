...
For testing practices → @.planning/codebase/TESTING.md
For known concerns & tech debt → @.planning/codebase/CONCERNS.md
For directory structure → @.planning/codebase/STRUCTURE.md
